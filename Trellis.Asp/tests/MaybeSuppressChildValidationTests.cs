    ...
    public class Name : ScalarValueObject<Name, string>, IScalarValue<Name, string>
    {
        ...
        public static Result<Name> TryCreate(string? value, string? fieldName = null)
        {
            ...
            if (string.IsNullOrWhiteSpace(value))
                return Result.Fail<Asp.Tests.MaybeSuppressChildValidationTests.Name>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(field), ValidationCodes.Unspecified) { Detail = "Name is required." })));
