...
public class ValidatingJsonConverterPrimitiveTypesTests
{
    ...
    public class StringVO : ScalarValueObject<StringVO, string>, IScalarValue<StringVO, string>
    {
        ...
        public static Result<StringVO> TryCreate(string? value, string? fieldName = null) =>
            string.IsNullOrEmpty(value) ? Result.Fail<StringVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "Required" }))) : Result.Ok(new StringVO(value));
    }
    ...
    public class GuidVO : ScalarValueObject<GuidVO, Guid>, IScalarValue<GuidVO, Guid>
    {
        ...
        public static Result<GuidVO> TryCreate(Guid value, string? fieldName = null) =>
            value == Guid.Empty ? Result.Fail<GuidVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "Required" }))) : Result.Ok(new GuidVO(value));
    ...
    public class IntVO : ScalarValueObject<IntVO, int>, IScalarValue<IntVO, int>
    {
        ...
        public static Result<IntVO> TryCreate(int value, string? fieldName = null) =>
            value < 0 ? Result.Fail<IntVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "Negative" }))) : Result.Ok(new IntVO(value));
    ...
    public class LongVO : ScalarValueObject<LongVO, long>, IScalarValue<LongVO, long>
    {
        ...
        public static Result<LongVO> TryCreate(long value, string? fieldName = null) =>
            value < 0 ? Result.Fail<LongVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "Negative" }))) : Result.Ok(new LongVO(value));
    ...
    public class DoubleVO : ScalarValueObject<DoubleVO, double>, IScalarValue<DoubleVO, double>
    {
        ...
        public static Result<DoubleVO> TryCreate(double value, string? fieldName = null) =>
            double.IsNaN(value) ? Result.Fail<DoubleVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "NaN" }))) : Result.Ok(new DoubleVO(value));
    ...
    public class FloatVO : ScalarValueObject<FloatVO, float>, IScalarValue<FloatVO, float>
    {
        ...
        public static Result<FloatVO> TryCreate(float value, string? fieldName = null) =>
            float.IsNaN(value) ? Result.Fail<FloatVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "NaN" }))) : Result.Ok(new FloatVO(value));
    ...
    public class DecimalVO : ScalarValueObject<DecimalVO, decimal>, IScalarValue<DecimalVO, decimal>
    {
        ...
        public static Result<DecimalVO> TryCreate(decimal value, string? fieldName = null) =>
            value < 0 ? Result.Fail<DecimalVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "Negative" }))) : Result.Ok(new DecimalVO(value));
    ...
    public class DateTimeVO : ScalarValueObject<DateTimeVO, DateTime>, IScalarValue<DateTimeVO, DateTime>
    {
        ...
        public static Result<DateTimeVO> TryCreate(DateTime value, string? fieldName = null) =>
            value == DateTime.MinValue ? Result.Fail<DateTimeVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "MinValue" }))) : Result.Ok(new DateTimeVO(value));
    ...
    public class DateTimeOffsetVO : ScalarValueObject<DateTimeOffsetVO, DateTimeOffset>, IScalarValue<DateTimeOffsetVO, DateTimeOffset>
    {
        ...
        public static Result<DateTimeOffsetVO> TryCreate(DateTimeOffset value, string? fieldName = null) =>
            value == DateTimeOffset.MinValue ? Result.Fail<DateTimeOffsetVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "MinValue" }))) : Result.Ok(new DateTimeOffsetVO(value));
    ...
    public class DateOnlyVO : ScalarValueObject<DateOnlyVO, DateOnly>, IScalarValue<DateOnlyVO, DateOnly>
    {
        ...
        public static Result<DateOnlyVO> TryCreate(DateOnly value, string? fieldName = null) =>
            value == DateOnly.MinValue ? Result.Fail<DateOnlyVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "MinValue" }))) : Result.Ok(new DateOnlyVO(value));
    ...
    public class TimeOnlyVO : ScalarValueObject<TimeOnlyVO, TimeOnly>, IScalarValue<TimeOnlyVO, TimeOnly>
    {
        ...
        public static Result<TimeOnlyVO> TryCreate(TimeOnly value, string? fieldName = null) =>
            value == TimeOnly.MinValue ? Result.Fail<TimeOnlyVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "MinValue" }))) : Result.Ok(new TimeOnlyVO(value));
    ...
    public class TimeSpanVO : ScalarValueObject<TimeSpanVO, TimeSpan>, IScalarValue<TimeSpanVO, TimeSpan>
    {
        ...
        public static Result<TimeSpanVO> TryCreate(TimeSpan value, string? fieldName = null) =>
            value < TimeSpan.Zero ? Result.Fail<TimeSpanVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "Negative" }))) : Result.Ok(new TimeSpanVO(value));
    ...
    public class ShortVO : ScalarValueObject<ShortVO, short>, IScalarValue<ShortVO, short>
    {
        ...
        public static Result<ShortVO> TryCreate(short value, string? fieldName = null) =>
            value < 0 ? Result.Fail<ShortVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "Negative" }))) : Result.Ok(new ShortVO(value));
    ...
    public class SByteVO : ScalarValueObject<SByteVO, sbyte>, IScalarValue<SByteVO, sbyte>
    {
        ...
        public static Result<SByteVO> TryCreate(sbyte value, string? fieldName = null) =>
            value < 0 ? Result.Fail<SByteVO>(new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(fieldName ?? "field"), ValidationCodes.Unspecified) { Detail = "Negative" }))) : Result.Ok(new SByteVO(value));
