...
///                    new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty("sku"), ValidationCodes.StringPattern) { Detail = "SKU can only contain letters, digits, and hyphens" })));
/// }
/// 
/// // Usage
