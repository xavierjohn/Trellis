...
/// var guard = Result.Ensure(order.IsOpen, new Error.Conflict(Resource: null, Code: "order.closed"));
///
/// // Value-threaded guard inside a pipeline:
/// var validated = parseAmount
///     .Ensure(amt =&gt; amt &gt; 0, Error.InvalidInput.ForField(field: "amount", code: ValidationCodes.ValueGreaterThan));
/// </code>
/// </example>
[DebuggerStepThrough]
