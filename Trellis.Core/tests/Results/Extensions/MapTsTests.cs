...
public class MapTsTests : TestBase
{
    ...
    {
        // Arrange
        var error = new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty("field"), ValidationCodes.Unspecified) { Detail = "Test error" }));
