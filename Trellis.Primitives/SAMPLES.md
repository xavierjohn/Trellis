...
public class EntityService
{
    ...
    public void ValidationScenarios()
    {
        ...
        // NewUniqueV7 always succeeds
        var result5 = EntityId.NewUniqueV7();
...
// Generated code by source generator (TrackingId.g.cs, simplified)
// <auto-generated/>
...
// Generated code by source generator (EmployeeId.g.cs, simplified)
// <auto-generated/>
namespace YourNamespace;
using Trellis;
using System.Diagnostics.CodeAnalysis;
...
public partial class EmployeeId : RequiredGuid, IParsable<EmployeeId>, ITryCreatable<EmployeeId>
{
    ...
    public static Result<EmployeeId> TryCreate(string? stringOrNull, string? fieldName = null)
    {
        ...
        return stringOrNull
            ...
            .Ensure(_ => parsedGuid != Guid.Empty, new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty(field), ValidationCodes.ValueNotDefault) { Detail = "Employee Id cannot be empty." })))
...
public class User : Entity<UserId>
{
    ...
    private User() : base(UserId.NewUniqueV7())
    {
    }
