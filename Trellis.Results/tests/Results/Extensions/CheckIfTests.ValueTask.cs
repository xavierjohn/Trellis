...
public class CheckIfTests_ValueTask
{
    ...
    public async Task CheckIfAsync_ValueTask_Bool_ConditionTrue_CheckPasses_ReturnsOriginal()
    {
        ...
        var sut = await resultTask.CheckIfAsync(true, v => new ValueTask<Result<string>>(Result.Success("ok")));
    ...
    public async Task CheckIfAsync_ValueTask_Bool_ConditionTrue_CheckFails_ReturnsFailure()
    {
        ...
        var sut = await resultTask.CheckIfAsync(true, _ => new ValueTask<Result<string>>(Result.Failure<string>(CheckError)));
    ...
    public async Task CheckIfAsync_ValueTask_Predicate_True_CheckPasses()
    {
        ...
        var sut = await resultTask.CheckIfAsync(v => v > 0, v => new ValueTask<Result<string>>(Result.Success("ok")));
    ...
    public async Task CheckIfAsync_ValueTask_Predicate_True_CheckFails()
    {
        ...
        var sut = await resultTask.CheckIfAsync(v => v > 0, _ => new ValueTask<Result<string>>(Result.Failure<string>(CheckError)));
