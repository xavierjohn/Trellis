...
public class Ensure_Task_Tests
{
    ...
    public async Task Ensure_Task_with_successInput_and_failurePredicate()
    {
        ...
        var result = await initialResult.EnsureAsync(() => Task.FromResult(Result.Fail<string>(Error.Unexpected("Error message"))));
    ...
    {
        var initialResult = Task.FromResult(Result.Fail<string>(Error.Unauthorized("Initial Error message")));
    ...
    {
        var initialResult = Task.FromResult(Result.Fail<string>(Error.Validation("Initial Error message")));
    ...
    {
        var initialResult = Task.FromResult(Result.Fail<string>(Error.Conflict("Initial Error message")));
