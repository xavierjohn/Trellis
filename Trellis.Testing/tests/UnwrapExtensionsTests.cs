...
{
    private static readonly Error TestError = new Error.InvalidInput(EquatableArray.Create(new FieldViolation(InputPointer.ForProperty("TestField"), ValidationCodes.Unspecified) { Detail = "Test validation error" }));
