...
- Real-world 409 cases lack a specific addressable resource: stateless workflow engines, state-machine guards (e.g. `Trellis.Stateless.FireResult`), library code with no aggregate context, multi-resource transactions.
