...
| `HttpResponseNoBody` | `http.response-no-body` | A response that had to carry a body did not — `204`/`205`, absent content, or a zero-length payload. Carried by `Error.Unexpected`; emitted by `Trellis.Http`. |
